...
namespace CECS475Lab1
{
    public class Stock
    {
        public event EventHandler StockEvent;
        ...
        private List<StockBroker> sBlist = new List<StockBroker>();
        ...
        public  void Sub(StockBroker sB)
        {
            sBlist.Add(sB);
        ...
        public void ChangeStockValue()
        {
            ...
            {  //RAISE THE EVENT 
                StockEvent?.Invoke(this, EventArgs.Empty);
